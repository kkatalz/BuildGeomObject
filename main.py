...
code = "ПОЗНАЧИТИ_ТОЧКf A1; Побудувати_відрізок B1M1; Побудувати_перпендикуляр MN до B1M1; ПОЗНАЧИТИ_ТОЧКf A; Побудувати_відрізок CJ; Відрізок KL перетинає відрізок CJ;#"
